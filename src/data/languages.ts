...
export const languages: Language[] = [
  ...
  },
  {
    ...
    clue: "Ge'ez/Ethiopic script like Amharic. Distinguished by frequent word-final ን (n), common ኣ vowel form, and particles like እዩ (is) and ኣብ (in/at).'ez/Ethiopic script as Amharic (blocky characters with stems and loops). Distinguished by different word patterns and verb conjugations.",
  ...
  },
  {
    ...
    clue: "Round, curvy script with many circular shapes and hooks. Each character has a distinctive rounded top (unlike Tamil's flat tops). Called 'Italian of the East' for vowel endings.",
  ...
  },
  {
    ...
    clue: "Very round, looped script — more circular than Tamil or Telugu. Characters have distinctive loops that hang below the line. Conjunct consonants are stacked vertically.",
  ...
  },
  {
    ...
    clue: "Round script similar to Telugu but with more angular tops and distinctive hooks. Characters often have a curve on the right side. Headline absent (unlike Hindi).",
