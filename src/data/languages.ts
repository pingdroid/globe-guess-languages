...
export const languages: Language[] = [
  ...
  {
    id: 'bengali', name: 'Bengali', aliases: ['bangla', 'বাংলা'], family: 'Indo-Aryan', region: 'Asia', tier: 2, script: 'Bengali-Assamese',
  ...
  {
    id: 'georgian', name: 'Georgian', aliases: ['kartuli', 'ქართული'], family: 'Kartvelian', region: 'Europe/Asia', tier: 3, script: 'Mkhedruli',
  ...
  {
    id: 'armenian', name: 'Armenian', aliases: ['hayeren', 'հայերեն'], family: 'Indo-European', region: 'Europe/Asia', tier: 3, script: 'Armenian',
    ...
    sentences: ["Այսօր շուկան ինչ ժամի՞ն է փակվում։", "Իմ տատիկը ապրում է մի փոքր գյուղում Գյումրիի մոտ։", "Օդի պայմանները ամբողջ շաբաթ բավական սառն էին։", "Ես ուզում եմ գնել երեք գիրք, խնդրում եմ։", "Երեխաները դրսում խաղում են, որովհետև եղանակը լավ է։", "Այստեղ մոտակայքում որտե՞ղ կարելի է գտնել լավ ռեստորան։", "Նա ասաց ինձ, որ չի հասկանում խնդիրը։", "Այս հին շենքը կառուցվել է երկու հարյուր տարի առաջ։", "Երևանի պետական համալսարանը տարածաշրջանում կարևոր կրթօջախ է։", "Հինգշաբթի աշխատանքից հետո ընկերներով թեյ ենք խմում։", "Վարդավառը այս տարի շատ մարդաշատ էր։", "Ազգային գրադարանը ամեն օր առավոտյան ութին է բացվում։", "Մեր հարևանի կատուն ամեն երեկո գալիս է մեր տանիք։", "Ցերեկները ընտանիքով թեյ ու քաղցրավենիք ենք ուտում։", "Այս տարի մենք չգնացինք արձակուրդ, մնացինք տանը։", "Երևանի երթևեկությունը ամեն օր ավելի վատ է դառնում, մետրոն ավելի լավն է։", "Ամռանը գնում ենք ծովով հանգստանալու։", "Կրպակը մեր փողոցի անկյունում վաղ առավոտյան է բացվում։", "Շուկայի մեջ պտուղների գները շատ բարձրացել են։", "Իմ մայրիկն միշտ հյուրերի համար խորոված է պատրաստում։", "Ֆարմացիան փոստի դիմաց այսօր փակ է։", "Իմ եղբայրը աշխատում է մի դեղատանը, որը գտնվում է կայարանի մոտ։", "Չգիտեմ, արդյոք սա լավ միտք է։", "Նա այսօր առավոտյան գնացքով նստեց։", "Իմ քույրը գնաց արձակուրդի։"]
  },
  {
    id: 'tamil', name: 'Tamil', aliases: ['thamizh', 'தமிழ்'], family: 'Dravidian', region: 'Asia', tier: 3, script: 'Tamil',
    clue: "Simpler rounded letters with flat tops and fewer hanging loops than Malayalam. Tamil feels more open and blocky, with curled bottoms and no headline.",
  ...
  {
    id: 'amharic', name: 'Amharic', aliases: ['amarigna', 'አማርኛ'], family: 'Semitic', region: 'Africa', tier: 3, script: 'Geʻez',
  ...
  {
    id: 'afrikaans', name: 'Afrikaans', aliases: ['afrikaans'], family: 'Germanic', region: 'Africa', tier: 4, script: 'Latin',
  ...
  {
    id: 'cantonese', name: 'Cantonese', aliases: ['yue', '粵語', '广东话'], family: 'Sinitic', region: 'Asia', tier: 2, script: 'Traditional Han',
  ...
  },
  {
    ...
    clue: "Similar to Thai but simpler and more angular — fewer loops. Uses tone marks (່, ້) above letters. No spaces between words. Characters have straighter vertical strokes.",
  ...
  {
    id: 'punjabi', name: 'Punjabi', aliases: ['panjabi'], family: 'Indo-Aryan', region: 'Asia', tier: 3, script: 'Gurmukhi',
  ...
  {
    id: 'burmese', name: 'Burmese', aliases: ['myanmar', 'bamar'], family: 'Sino-Tibetan', region: 'Asia', tier: 3, script: 'Myanmar',
  ...
  {
    id: 'croatian', name: 'Croatian', aliases: ['hrvatski'], family: 'Slavic', region: 'Europe', tier: 4, script: 'Latin',
  ...
  {
    id: 'mongolian', name: 'Mongolian', aliases: ['mongol', 'монгол'], family: 'Mongolic', region: 'Asia', tier: 3, script: 'Cyrillic',
  ...
  },
  {
    ...
    clue: "Ge'ez/Ethiopic script like Amharic, but Tigrinya stands out with frequent word-final ን (n), particles such as እዩ (is) and ኣብ (in/at), and its own verb/word patterns.",
  ...
  {
    id: 'haitian-creole', name: 'Haitian Creole', aliases: ['kreyol', 'kreyol ayisyen'], family: 'French Creole', region: 'Americas', tier: 3, script: 'Latin',
    clue: "French-based but drastically simplified. No conjugation (m ap, ou ap, li ap = I am, you are, he is + verb). W replaces French 'oi' (mwen, bwa). è instead of French ai/ê.",
    confusedWith: ['French', 'Cajun French'],
    sentences: ["Ki lè mache a fèmen jodi a?", "Grann mwen rete nan yon ti vilaj tou pre Pòtoprens.", "Tan an te frèt anpil tout semèn nan.", "Mwen ta renmen achte twa liv, tanpri.", "Timoun yo ap jwe deyò paske tan an bon.", "Ki kote mwen ka jwenn yon bon restoran nan zòn sa a?", "Li di m li pa konprann pwoblèm nan.", "Ansyen bilding sa a te konstwi desan zan de sa.", "Konpa se mizik ki pi popilè nan peyi Dayiti.", "Diri ak sos pwa se manje nou manje chak jou.", "Nan Kanaval, tout moun desann nan lari pou danse.", "Taptap la te plen, pa t gen plas pou chita.", "Lè lapli tonbe, lari yo plen dlo toupatou.", "Manman m toujou fè griot ak bannann peze pou dimanch.", "Nan sezon siklòn, tout moun prepare kay yo.", "Machann nan mache a vann legim fre chak maten.", "Kouran an ale ankò, nou dwe itilize chandèl.", "Nan mwa janvye nou selebre endepandans peyi a.", "Jouk nan solèy kouche, moun yo chita ap pale anba pyebwa.", "Rasin mizik pote istwa ak tradisyon nou.", "Famasi a anfas lapòs la fèmen jodi a.", "Granpapa m te travay nan yon boulanjri lè l te jèn.", "Mwen pa sèten sa se yon bon lide.", "Li monte nan tren an nan maten.", "Sè m nan ale an vakans."]
  },
  {
    id: 'bulgarian', name: 'Bulgarian', aliases: ['balgarski', 'български'], family: 'Slavic', region: 'Europe', tier: 3, script: 'Cyrillic',
    clue: "Cyrillic but NO case system (unlike Russian). Definite articles suffixed to nouns (-ът/-та/-то). Uses ъ (big yer) frequently where Russian doesn't.",
    confusedWith: ['Russian', 'Macedonian', 'Serbian'],
    sentences: ["В колко часа затваря пазарът днес?", "Баба ми живее в малко село близо до Пловдив.", "Времето беше доста студено цялата седмица.", "Бих искал да купя три книги, моля.", "Децата играят навън, защото времето е хубаво.", "Къде наблизо мога да намеря добър ресторан?", "Тя ми каза, че не разбира проблема.", "Тази стара сграда е построена преди двеста години.", "Рилският манастир е най-известната забележителност в България.", "Баницата и киселото мляко са нашата традиционна закуска.", "На Бъдни вечер цялото семейство се събира на празнична вечеря.", "Автобусът закъсня двадесет минути заради трафика.", "Розовата долина е известна в целия свят с розовото масло.", "Всяка неделя баба прави баница със сирене и спанак.", "Именният ден е също толкова важен колкото рождения ден.", "На морето ходим всяко лято, най-често в Созопол.", "Кафето се пие бавно на терасата с приятели.", "Мартениците се носят от първи март за здраве.", "Кукерските игри се провеждат в много градове през зимата.", "Сметките за ток се увеличиха значително тази зима.", "Аптеката срещу пощата е затворена днес.", "Дядо ми работеше в пекарна в покрайнините на града.", "Не съм сигурен, че това е добра идея.", "Той се качи на влака тази сутрин.", "Сестра ми замина на почивка."]
  },
  {
    id: 'galician', name: 'Galician', aliases: ['galego'], family: 'Romance', region: 'Europe', tier: 4, script: 'Latin',
    clue: "Looks like Portuguese but with Spanish spelling conventions. Uses ñ (like Spanish) AND -ción (not -ção). No ã or õ nasal vowels (unlike Portuguese).",
    confusedWith: ['Portuguese', 'Spanish'],
    sentences: ["A que hora pecha o mercado hoxe?", "A miña avoa vive nunha aldea pequena preto de Santiago de Compostela.", "O tempo estivo bastante frío toda a semana.", "Gustaríame mercar tres libros, por favor.", "Os nenos xogan fóra porque fai bo tempo.", "Onde podo atopar un bo restaurante por aquí preto?", "Díxome que non entendía o problema.", "Este vello edificio foi construído hai douscentos anos.", "O Camiño de Santiago atrae peregrinos de todo o mundo.", "O polbo á feira é un dos pratos máis típicos de Galicia.", "Cando chove, os regueiros baixan cheos de auga pola montaña.", "O autobús chegou tarde vinte minutos por mor do tráfico.", "Os domingos a familia xúntase para comer no restaurante do pobo.", "A queimada faise con augardente e conxuros na noite de San Xoán.", "O marisco fresco véndese no porto todas as mañás.", "As festas do Apóstolo en xullo son as máis importantes.", "A gaita e o pandeiro son instrumentos tradicionais galegos.", "No inverno a choiva non para durante semanas enteiras.", "O caldo galego con grelos e unto é perfecto para o frío.", "A morriña é a saudade que senten os galegos lonxe da terra.", "A farmacia diante do correo está pechada hoxe.", "O meu avó traballaba nunha panadería na vila.", "Non estou seguro de que sexa unha boa idea.", "Colleu o tren esta mañá cedo.", "A miña irmá marchou de vacacións."]
  },
  {
    id: 'kurdish', name: 'Kurdish', aliases: ['kurdi', 'kurdî'], family: 'Iranian', region: 'Middle East', tier: 3, script: 'Latin',
    clue: "Latin script (Kurmanji variant) with circumflex vowels: î, û, ê. Uses x (voiceless velar) and q (uvular). No ö, ü, or ğ (unlike Turkish).",
    confusedWith: ['Turkish', 'Persian', 'Azerbaijani'],
    sentences: ["Sûk îro saet çend dadixe?", "Dapîra min li gundekî biçûk li nêzî Duhokê dijî.", "Hewa tevahiya hefteyê pir sar bû.", "Ez dixwazim sê pirtûkan bikirim, ji kerema xwe.", "Zarok li derve dilîzin ji ber ku hewa xweş e.", "Li ku derê ez dikarim li vir nêzîk xwaringgehek baş bibînim?", "Wê ji min re got ku pirsgirêkê fêm nake.", "Ev avahiya kevn berî dused salan hatiye çêkirin.", "Newroz cejna herî girîng a gelê kurd e.", "Nan û mast xwarina me ya rojane ye.", "Di dawetên kurdan de govend tê gerîn û stran tê gotin.", "Otobus bîst deqîqe dereng hat ji ber trafîkê.", "Çiyayên Kurdistanê di zivistanê de bi berfê têne nixamtin.", "Diya min her roja yekşemê dolma çêdike.", "Di havînê de em diçin golan û di avê de mêle dikin.", "Çaya bi şîr û şekir li her derê tê vexwarin.", "Zivistanê berfê ji erdê ra dide û pir sar dibe.", "Li bazarê fêkî û sebze pir erzan in.", "Stranên kurdî bi saz û deholê tên gotin.", "Xaniyên kevn ên gund ji kevirên çiyê hatine çêkirin.", "Dermanxane ya li ber postexaneyê îro girtî ye.", "Bapîrê min dema ciwan bû li firnê dixebitî.", "Ez ne bawer im ku ev ramanek baş e.", "Wî sibehê zû siwar bû trênê.", "Xwişka min çû betlaneyê."]
  },
  {
    id: 'belarusian', name: 'Belarusian', aliases: ['belaruskaya', 'беларуская'], family: 'Slavic', region: 'Europe', tier: 3, script: 'Cyrillic',
    clue: "Cyrillic with unique letter ў (short u/w — found ONLY in Belarusian). Also uses і (like Ukrainian) instead of Russian и. Apostrophe instead of ъ.",
    confusedWith: ['Russian', 'Ukrainian'],
    sentences: ["А якой гадзіне сёння зачыняецца рынак?", "Мая бабуля жыве ў невялічкай вёсцы каля Мінска.", "Надвор'е было даволі халоднае ўвесь тыдзень.", "Я хацеў бы купіць тры кнігі, калі ласка.", "Дзеці гуляюць на вуліцы, бо надвор'е добрае.", "Дзе тут паблізу можна знайсці добры рэстаран?", "Яна сказала мне, што не разумее праблему.", "Гэты стары будынак быў пабудаваны двесце гадоў таму.", "Мінск — гэта горад з шырокімі праспектамі і паркамі.", "Дранікі з мяса і бульбы — нашая нацыянальная страва.", "На Каляды мы збіраемся ўсёй сям'ёй за святочным сталом.", "Аўтобус спазніўся на дваццаць хвілін з-за заторуаў.", "Белавежская пушча — адзін з апошніх старажытных лясоў Еўропы.", "Бабуля заўсёды гатуе мачанку з бліноў на нядзелю.", "Лета кароткае, але вельмі прыгожае ў Беларусі.", "У нядзелю мы ходзім у лес збіраць грыбы і ягады.", "Бульба — галоўны прадукт беларускай кухні.", "Зімой вельмі рана цямнее, ужо а пятай гадзіне.", "На кірмашы прадаюць ручную вырабку і мёд.", "Кватэра каштуе ўсё даражэй, асабліва ў цэнтры.", "Аптэка насупраць пошты сёння зачыненая.", "Мой дзядуля ў маладосці працаваў у пякарні.", "Я не ўпэўнены, што гэта добрая ідэя.", "Ён сеў на цягнік раніцай.", "Мая сястра паехала ў адпачынак."]
  },
  {
    id: 'latin', name: 'Latin', aliases: ['latina', 'lingua latina'], family: 'Italic', region: 'Europe', tier: 4, script: 'Latin',
    clue: "No articles (no the/a/an). Words end in -us, -um, -a, -ae, -is, -orum. Verb at end of sentence. No j, w. Highly inflected (word endings change meaning).",
    confusedWith: ['Italian', 'Romanian', 'Spanish'],
    sentences: ["Quota hora forum clauditur hodie?", "Avia mea in parvo vico prope Romam habitat.", "Tempestas tota hebdomade satis frigida fuit.", "Tres libros emere velim, quaeso.", "Pueri foris ludunt quod tempestas bona est.", "Ubi bonam cauponam hic prope invenire possum?", "Dixit mihi se problema non intellegere.", "Hoc vetus aedificium ducentis abhinc annis aedificatum est.", "Lingua Latina per multa saecula lingua scientiae fuit.", "Romani vias longas per totum imperium construxerunt.", "In foro mercatores merces suas vendebant cotidie.", "Cursus publicus epistulas per totum imperium ferebat.", "Senatus populusque Romanus res publicas administrabat.", "Aquaeductus aquam puram in urbem ducebant.", "Gladiatores in amphitheatro pugnabant ad populum delectandum.", "Thermae publicae locus conventus et otii erant.", "Milites Romani per totum orbem terrarum pugnaverunt.", "Philosophi Graeci et Romani de natura rerum disputaverunt.", "Discipuli in schola litteras et numeros discebant.", "Templa deorum in omnibus urbibus Romanis inventa sunt.", "Apotheca ex adverso tabellariae hodie clausa est.", "Avus meus adulescens in pistrino laborabat.", "Incertus sum num haec bona sententia sit.", "Mane in currum ferreum ascendit.", "Soror mea in ferias profecta est."]
  },
  {
    id: 'telugu', name: 'Telugu', aliases: ['telugu', 'తెలుగు'], family: 'Dravidian', region: 'Asia', tier: 3, script: 'Telugu',
    clue: "Very rounded letters with pronounced circular bowls and distinctive, broad rounded tops. Telugu characters often look like clusters of circles linked by thin strokes.",
    confusedWith: ['Kannada', 'Tamil', 'Malayalam'],
    sentences: ["ఈ రోజు మార్కెట్ ఎన్ని గంటలకు మూసేస్తారు?", "మా నాయనమ్మ హైదరాబాద్ దగ్గర ఒక చిన్న ఊళ్ళో ఉంటారు.", "ఈ వారమంతా వాతావరణం చాలా చల్లగా ఉంది.", "నేను మూడు పుస్తకాలు కొనాలనుకుంటున్నాను.", "పిల్లలు బయట ఆడుకుంటున్నారు ఎందుకంటే వాతావరణం బాగుంది.", "ఇక్కడ దగ్గరలో మంచి రెస్టారెంట్ ఎక్కడ దొరుకుతుంది?", "ఆమె నాకు సమస్య అర్థం కాలేదని చెప్పింది.", "ఈ పాత భవనం రెండు వందల సంవత్సరాల క్రితం నిర్మించబడింది.", "తిరుమల వెంకటేశ్వర ఆలయం ప్రపంచంలో అత్యంత సందర్శించబడే ప్రదేశం.", "బిర్యానీ మరియు పులిహోర మా ఇష్టమైన వంటకాలు.", "సంక్రాంతి పండుగలో ఎడ్ల పందాలు జరుగుతాయి.", "బస్ నిండిపోయింది, నిలబడి వెళ్ళాల్సి వచ్చింది.", "వేసవిలో మామిడి పండ్లు బాగా దొరుకుతాయి.", "అమ్మ ప్రతి ఆదివారం పప్పు చారు చేస్తారు.", "దసరా పండుగలో బొమ్మల కొలువు పెడతారు.", "సినిమా హాల్లో కొత్త సినిమా చూడటానికి పెద్ద క్యూ ఉంది.", "కరెంట్ మళ్ళీ పోయింది, కొవ్వొత్తి వెలిగించాలి.", "వరి చేలలో నాట్లు వేసే సమయం వచ్చింది.", "సాయంత్రం టీ తాగుతూ స్నేహితులతో కబుర్లు చెప్పుకుంటాం.", "పెళ్ళిలో బంధువులందరూ కలుస్తారు.", "మందుల దుకాణం పోస్ట్ ఆఫీస్ ఎదురుగా ఈ రోజు మూసి ఉంది.", "మా తాతగారు చిన్నతనంలో బేకరీలో పని చేసేవారు.", "ఇది మంచి ఆలోచన అని నాకు ఖచ్చితంగా తెలియదు.", "అతను ఉదయం ట్రైన్ ఎక్కాడు.", "మా అక్క సెలవుకి వెళ్ళింది."]
  },
  {
    id: 'luxembourgish', name: 'Luxembourgish', aliases: ['letzebuergesch', 'lëtzebuergesch'], family: 'Germanic', region: 'Europe', tier: 4, script: 'Latin',
    clue: "Germanic language mixing German structure with French loanwords. Uses ë (schwa) frequently. Double vowels (éi, äi, ou). Looks like misspelled German with French words mixed in.",
    confusedWith: ['German', 'Dutch', 'French'],
    sentences: ["Wéini mécht de Maart haut zou?", "Meng Boma wunnt an engem klenge Duerf bei der Stad Lëtzebuerg.", "D'Wieder war déi ganzt Woch relativ kal.", "Ech géif gäre dräi Bicher kafen, wann ech gelift.", "D'Kanner spillen dobaussen well d'Wieder schéin ass.", "Wou fanne mer hei an der Géigend e gudde Restaurant?", "Si huet mer gesot datt si de Problem net versteet.", "Dëst aalt Gebai gouf virun zwee honnert Joer gebaut.", "D'Stad Lëtzebuerg ass eng vun de klengste Haaptstied an Europa.", "Bouneschlupp ass eng typisch lëtzebuergesch Zopp mat grénge Bounen.", "Op der Schueberfouer gëtt et Karrussellen a Fritten mat Grillwurscht.", "De Bus hat zwanzeg Minutten Verspéidung wéinst dem Traffic.", "Sonndes geet d'Famill zesummen an d'Brasserie fir ze iessen.", "Am Wanter ass et schonn géint véier Auer donkel.", "D'Nationalfeierdag ass den 23. Juni mat Feierwierk a Musek.", "Moies drénke mer Kaffi mat enger Bretzel oder engem Stréissel.", "D'Grenznopere kommen oft eriwwer fir ze schaffen.", "Am Hierscht sammele mer Äppel a Biren am Gaart.", "De Vëlo ass dat bescht Transportmëttel duerch d'Stad.", "D'Sproochevilfalt ass en Deel vum lëtzebuergesche Liewen.", "D'Apdikt vis-à-vis vun der Post ass haut zou.", "Mäi Bopa huet a senger Jugend an enger Bäckerei geschafft.", "Ech si mer net sécher ob dat eng gutt Iddi ass.", "Hie war moies mam Zuch gefuer.", "Meng Schwëster ass an d'Vakanz gefuer."]
  },
  {
    id: 'pashto', name: 'Pashto', aliases: ['pakhto', 'پښتو'], family: 'Iranian', region: 'Asia', tier: 4, script: 'Arabic-Pashto',
    clue: "Arabic-based script but with extra letters unique to Pashto: ښ, ږ, ټ, ډ, ړ, ڼ, ئ. Written right-to-left. More angular than Persian Nastaliq.",
    confusedWith: ['Arabic', 'Persian', 'Urdu'],
    sentences: ["نن بازار په کومه ساعت بندیږي?", "زما نیا د کابل سره نژدې په یوه کوچنۍ کلي کې اوسیږي.", "ټوله اوونۍ هوا ډیره سړه وه.", "زه غواړم درې کتابونه واخلم.", "ماشومان بهر لوبې کوي ځکه چې هوا ښه ده.", "دلته نژدې ښه رستورانت چیرته موندلی شم?", "هغې ته ویل چې ستونزه نه پوهیږي.", "دا زوړ ودانۍ دوه سوه کاله مخکې جوړه شوې.", "د افغانستان غرونه ډیر ښکلي دي په ژمي کې.", "قابلي پلاو زموږ تر ټولو خوند لرونکی خواړه ده.", "د اختر په ورځ ټوله کورنۍ یوځای راغونډیږي.", "بس ډک و او د ناستې ځای نه و.", "د پسرلي موسم کې ګلونه خورا ښکلي وي.", "مور هر ورځ شوربا پخوي.", "د ژمي په موسم کې واوره اوري.", "چای له شیدو سره هر ماښام څښل کیږي.", "د بازار نرخونه هره ورځ لوړیږي.", "د واده مراسم درې ورځې دوام کوي.", "بریښنا بیا تللې ده، شمعه باید ولګوو.", "کروندې ته د اوبو لګولو وخت راغلی دی.", "دوا خانه د پوسټ خانې مخې ته نن بنده ده.", "زما نیکه ځوان وو چې په نانوایۍ کې یې کار کاوه.", "ډاډه نه یم چې دا ښه فکر وي.", "هغه سهار ریل ته وخوت.", "خور مې رخصتۍ ته لاړه."]
  },
  {
    id: 'sinhala', name: 'Sinhala', aliases: ['sinhalese', 'සිංහල'], family: 'Indo-Aryan', region: 'Asia', tier: 3, script: 'Sinhala',
    clue: "Extremely round, circular script — nearly every character is based on loops and circles. One of the roundest scripts in the world. No angular strokes.",
    confusedWith: ['Burmese', 'Georgian', 'Thai'],
    sentences: ["අද වෙළඳපොළ කීයටද වැසෙන්නේ?", "මගේ ආච්චි කොළඹට ආසන්න කුඩා ගමක ජීවත් වෙනවා.", "සතිය පුරාම කාලගුණය තරමක් සීතල විය.", "මට පොත් තුනක් ගන්න ඕනෑ.", "දරුවන් පිටත සෙල්ලම් කරනවා මොකද කාලගුණය හොඳයි.", "මේ අවට හොඳ අවන්හලක් කොහෙන්ද හොයාගන්නේ?", "ඇය මට කිව්වා ප්‍රශ්නය තේරෙන්නේ නැහැ කියලා.", "මේ පරණ ගොඩනැගිල්ල අවුරුදු දෙසීයකට කලින් සාදන ලදී.", "සිංහල අලුත් අවුරුද්ද අප්‍රේල් මාසයේ සමරනවා.", "බත් සහ ව්‍යංජන අපේ ප්‍රධාන ආහාරයයි.", "වෙසක් පෝය දිනයේ පන්සල්වලට යනවා.", "බස් එක පිරිලා තිබුණා, ඉඳගන්න තැනක් නැතිව ගියා.", "මහ වැස්සට පාරවල් යටට වතුර ගියා.", "අම්මා හැම ඉරිදාම කිරි බත් හදනවා.", "පෙරහැර කාලයේ නැටුම් සහ බෙර වාදනය තියෙනවා.", "පොල් සම්බෝලය සහ ලුණුමිරිස් අපේ කෑමට අත්‍යවශ්‍යයි.", "වියළි කාලයේ ජලය හිඟයි.", "කොළඹ ට්‍රැෆික් එක දිනෙන් දිනේ වැඩි වෙනවා.", "තේ කෝප්පයක් බීමට උදේ පාන්දර එකට කැමතියි.", "ගමේ වී කුඹුරේ වැඩ කරන කාලය ආවා.", "ඖෂධ ශාලාව තැපැල් කාර්යාලයට ඉදිරියෙන් අද වසා ඇත.", "මගේ සීයා තරුණ කාලේ බේකරියේ වැඩ කළා.", "ඒක හොඳ අදහසක්ද කියලා මට විශ්වාස නැහැ.", "උදේම ඔහු දුම්රියට නැග්ගා.", "මගේ අක්කා නිවාඩුවට ගියා."]
  },
  {
    id: 'cebuano', name: 'Cebuano', aliases: ['bisaya', 'sinugbuanon'], family: 'Austronesian', region: 'Asia', tier: 4, script: 'Latin',
    clue: "Frequent 'og' (and), 'sa' (in/at/to), 'ang' (the), 'nga' (that/which). More Spanish loanwords than Tagalog. Words often end in vowels or 'g'.",
    confusedWith: ['Tagalog', 'Indonesian'],
    sentences: ["Unsang orasa magsira ang merkado karon?", "Ang akong lola nagpuyo sa gamay nga baryo duol sa Cebu.", "Bugnaw kaayo ang panahon sa tibuok semana.", "Gusto nako mopalit og tulo ka libro.", "Ang mga bata nagdula sa gawas kay nindot ang panahon.", "Asa man ko makakita og maayong restoran dinhi duol?", "Miingon siya nako nga wala siya nakasabot sa problema.", "Kining karaan nga building gitukod duha ka gatos ka tuig na ang milabay.", "Ang Sinulog mao ang labing bantog nga fiesta sa Cebu.", "Lechon baboy mao ang pinakahilig nga pagkaon sa mga Bisaya.", "Sa Pasko ang tibuok pamilya magtigom og magkaon og puto bumbong.", "Ang jeepney puno na, kinahanglan maghulat og lain.", "Bagyo ang nakaapekto sa atong lugar karong bulan.", "Si Mama nagluto og kinilaw og sinugba sa isda.", "Sa ting-init mainit kaayo, mga kwarenta grados.", "Magsimba mi matag Domingo sa kapilya sa baryo.", "Ang tindahan sa gamay nga karsada bukas hangtod gabii.", "Brownout na pud, kinahanglan mag gamit og kandila.", "Mag-inom og tuba pagkahuman sa trabaho mao ang kostumbre.", "Ang dagat sa Moalboal nindot kaayo para mag-snorkel.", "Ang botika atbang sa post office sirado karon.", "Ang akong lolo nagtrabaho sa panaderia sa iyang kabatan-on.", "Wala ko kasiguro nga maayo ba kana nga ideya.", "Misakay siya sa bus pagkabuntag.", "Ang akong igsoong babaye miadto og bakasyon."]
  },
  {
    id: 'tongan', name: 'Tongan', aliases: ['lea faka-tonga'], family: 'Austronesian', region: 'Oceania', tier: 4, script: 'Latin',
    clue: "Only 17 letters used. Glottal stop (fakauʻa) written as ʻ is extremely common. Vowel-heavy with frequent long vowels. Words: ko, ʻa, ʻi, mo, pea, ki.",
    confusedWith: ['Samoan', 'Maori', 'Hawaiian'],
    sentences: ["Ko e hā e taimi ʻe tāpuni ai e māketi he ʻahó ni?", "ʻOku nofo ʻa ʻeku kuí ʻi ha kiʻi kolo ofi ki Nukuʻalofa.", "Naʻe momoko ʻa e ʻea ʻi he uike kotoa.", "ʻOku ou fie fakatau ha tohi ʻe tolu.", "ʻOku va ʻinga ʻa e fānau ʻi tuʻa he ʻoku lelei ʻa e ʻea.", "Ko fē e feituʻu te u maʻu ai ha falekai lelei ofi heni?", "Naʻá ne tala kiate au ʻoku ʻikai ke ne ʻilo e palopalema.", "Ko e fale motuʻa ko eni naʻe langa ʻi he taʻu ʻe uangeau kuo hili.", "Ko e kava ʻa e meʻainu fakafonua ʻo Tonga.", "ʻOku fai e lotu ʻi he Sāpate kotoa ʻi Tonga.", "ʻI he Uike Lotu ʻoku tāpui e meʻa kotoa.", "Naʻe fonu e pasi, naʻe ʻikai ha nofoʻanga.", "ʻOku ʻaonga e ʻufi mo e talo ki he kai fakaʻaho.", "ʻOku teuteu e kātoanga tau ʻa e fānau.", "ʻI he faʻahitaʻu māfana ʻoku lahi e ʻuha.", "Ko e lakalaka mo e maʻuluʻulu ko e hiva fakafonua ia.", "ʻOku kai e lū pulu mo e ʻota ʻi he kai efiafi.", "Ko e toutai iku ʻoku mahuʻinga ki he moʻui fakaTonga.", "ʻOku fakaʻapaʻapa lahi ki he tuʻi mo e houʻeiki.", "ʻI he Kalisimasi ʻoku fiefia e kāinga kotoa.", "Ko e fale faitoʻo ʻoku fehangahangai mo e ʻōfisi meili ʻoku tāpuni he ʻahó ni.", "Ko ʻeku tamai naʻá ne ngāue ʻi he fale mā ʻi heʻene kei talavou.", "ʻOku ʻikai te u fakapapauʻi ko e fakakaukau lelei ia.", "Naʻá ne heka ki he lēlue ʻi he pongipongi.", "Kuo ʻalu ʻa hoku tuofefine ki he mālōlō."]
  },
  {
    id: 'occitan', name: 'Occitan', aliases: ['occitan', 'lenga doc'], family: 'Romance', region: 'Europe', tier: 4, script: 'Latin',
    clue: "Looks between French and Catalan/Spanish. Uses ò and ç like Catalan. Definite articles: lo, la, los, las (not le/la like French). Frequent -ada, -atge endings.",
    confusedWith: ['Catalan', 'French', 'Spanish'],
    sentences: ["A quina ora se barra lo mercat uèi?", "Ma grand-mòre viu dins un pichòt vilatge prèp de Tolosa.", "Lo tèmps es estat fòrça frèg tota la setmana.", "Vòli crompar tres libres, se vos plai.", "Los mainats jògan defòra perque lo tèmps es plan.", "Ont pòdi trobar un bon restaurant per aquí prèp?", "M'a dich que comprenía pas lo problèma.", "Aqueste bastiment vièlh foguèt bastit fa doas centas ans.", "L'occitan es parlat dins lo miègjorn de França.", "Lo cassòla e lo confit son de plats tradicionaus del país.", "Quand la tramontana bufa, fa un frèg glacial.", "Lo bus a retrasat de vint minutas a causa del trafic.", "Lo dimòli anam comprar pan e formatge al mercat.", "Los pastres menèron lors fedas dins la montanha d'estiu.", "Lo carnaval de Limós es un dels mai ancians d'Euròpa.", "La jovent del vilatge aprèn l'occitan a l'escòla.", "Al casal lo dimòli, i a balèti e cantas traditionalas.", "Lo vin de Galhac es conegut dins lo mond entièr.", "Las aròmas de lavanada embòrnan los camins de Provènça.", "Lo país catàr gardèt sa lenga malgrat sègles de pression.", "La farmacia al devant de la pòsta es barrada uèi.", "Mon pairin trabalhèt dins una panetariá quand èra jòune.", "Sèi pas segur que siá una bona idèia.", "Montèt dins lo tren al matin.", "Ma sòrre anèt en vacanças."]
  },
  {
    id: 'corsican', name: 'Corsican', aliases: ['corsu', 'lingua corsa'], family: 'Romance', region: 'Europe', tier: 4, script: 'Latin',
    clue: "Looks very similar to Italian but with more gh, chj, and double consonants. Uses ù frequently. Words end in -u (not -o like Italian): bellu, corsu, paësu.",
    confusedWith: ['Italian', 'Sardinian'],
    sentences: ["A chì ora si chjode u mercatu oghje?", "A me mammone campà in un paisellu chjucu accantu à Aiacciu.", "U tempu hè statu abbastanza friddu tutta a settimana.", "Vogliu cumprà trè libri, per piacè.", "I zitelli ghjocanu fora perchè u tempu hè bellu.", "Induve possu truvà un bonu risturante quì accantu?", "M'hà dettu chì ùn capiscia micca u prublema.", "Stu vechju fabbricatu hè statu custruitu duicentu anni fà.", "A Corsica hè una isula di muntagne è di mare.", "U prisuttu è u brucciu sò i prudutti tipichi corsi.", "A festa di San Ghjuvan hè a più impurtante di l'estate.", "L'autobusu hà ritardatu vinti minuti per via di u trafficu.", "A dumenica a famiglia si riunisce per manghjà inseme.", "I castagneti furniscenu a farina per fà u pulenta.", "U mare hè bellu d'estate, ci bagnemu ogni ghjornu.", "I pastori portanu e so pecore in muntagna l'estate.", "U cantu polifonicu corsu hè patrimoniu di l'umanità.", "Quandu u libecciu soffia, u mare hè troppu grossu per pescà.", "A macchia corsa hè piena di mirtu è d'arbustru.", "U fòcu di i boschi hè un prublema seriu ogni estate.", "A farmacia di fronte à a posta hè chjusa oghje.", "U me babbone travagliava in una panetteria quandu era ghjovanu.", "Ùn sò micca sicuru chì sia una bona idea.", "Hè muntatu nant'à u trenu a matina.", "A me surella hè andata in vacanza."]
  },
  {
    id: 'kyrgyz', name: 'Kyrgyz', aliases: ['kirgiz', 'кыргызча'], family: 'Turkic', region: 'Asia', tier: 4, script: 'Cyrillic',
    clue: "Cyrillic Turkic with unique letters: Ң, Ү, Ө (like Kazakh) but also Ё used frequently. Shorter words than Kazakh. Vowel harmony throughout.",
    confusedWith: ['Kazakh', 'Russian', 'Uzbek'],
    sentences: ["Бүгүн базар саат канчада жабылат?", "Менин чоң энем Бишкекке жакын кичинекей айылда жашайт.", "Жума бою аба ырайы абдан суук болду.", "Үч китеп сатып алгым келет.", "Балдар сыртта ойноп жатышат, анткени аба ырайы жакшы.", "Бул жерде жакшы ресторан кайдан тапса болот?", "Ал мага маселени түшүнбөйт деп айтты.", "Бул эски имарат эки жүз жыл мурун курулган.", "Ысык-Көл дүйнөдөгү эң чоң тоо көлдөрүнүн бири.", "Бешбармак кыргыздардын улуттук тамагы.", "Нооруз майрамында сүмөлөк бышырылат.", "Автобус жыйырма мүнөт кечикти.", "Жайлоодо мал багуу кыргыз элинин салты.", "Кымыз жана курут биздин салттуу тамак-ашыбыз.", "Кышында тоолордо кар көп жаайт.", "Манас эпосу кыргыз маданиятынын символу.", "Базарда жемиш жана жашылча абдан арзан.", "Жамгыр жаап, көчөлөр суу басты.", "Жайында Соң-Көлгө барып, боз үйдө жашайбыз.", "Ат мингенди ар бир кыргыз бала билет.", "Дарыкана почтанын каршысында бүгүн жабык.", "Чоң атам жаш кезинде нан бышыра турган жерде иштеген.", "Бул жакшы идея экенине ишенбейм.", "Ал эртең менен поездге минди.", "Эжем эс алууга кетти."]
  },
  {
    id: 'bosnian', name: 'Bosnian', aliases: ['bosanski', 'босански'], family: 'Slavic', region: 'Europe', tier: 4, script: 'Latin',
    clue: "Nearly identical to Serbian/Croatian but uses more Turkish/Arabic loanwords (čaršija, ćevapi, džamija, mahala). Same diacritics: č, ć, š, ž, đ.",
    confusedWith: ['Serbian', 'Croatian', 'Montenegrin'],
    sentences: ["Kad se danas zatvara zelena pijaca?", "Moja nana živi u malom selu blizu Sarajeva.", "Vrijeme je bilo prilično hladno cijelu sedmicu.", "Trebam kupiti tri knjige za školu, molim vas.", "Klinci se igraju na sokaku jer je napolju toplo.", "Ima li ovdje negdje u blizini dobra ćevabdžinica?", "Kaže da joj nije jasno u čemu je problem.", "Ova stara zgrada izgrađena je prije dvjesta godina.", "Baščaršija je srce starog Sarajeva sa zanatskim radnjama.", "Ćevapi u somunu sa lukom su naša najpoznatija hrana.", "Za Bajram se porodica okuplja i priprema se baklavа.", "Autobus je kasnio dvadeset minuta zbog saobraćaja.", "Bosanska kahva se pije iz fildžana uz lokum.", "Komšiluk je važan dio života u bosanskim mahalama.", "Zimi se u planinama skija, a ljeti se ide na rijeku.", "Iftar u Ramazanu je poseban porodični trenutak.", "Stari most u Mostaru privlači hiljade turista godišnje.", "Pita zeljanica i burek su na svakom sofri ujutro.", "Akšam je posebno lijep uz ezan sa minareta.", "Priroda u Bosni je predivna, šume i rijeke svuda.", "Apoteka naspram pošte je danas zatvorena.", "Moj dedo je radio u pekari na periferiji grada.", "Ne znam baš da li je to pametna odluka.", "Ujutru je sjeo u voz.", "Sestra mi je otputovala na more."]
  },
  {
    id: 'malayalam', name: 'Malayalam', aliases: ['malayalam', 'മലയാളം'], family: 'Dravidian', region: 'Asia', tier: 3, script: 'Malayalam',
    clue: "Dense rounded script with many vertical loops and hanging tails. Malayalam letters often have more stacked conjuncts and a heavier, flowing appearance than Telugu.",
    confusedWith: ['Tamil', 'Telugu', 'Sinhala'],
    sentences: ["ഇന്ന് മാർക്കറ്റ് എത്ര മണിക്ക് അടയ്ക്കും?", "എന്റെ അമ്മൂമ്മ കൊച്ചിക്കടുത്ത് ഒരു ചെറിയ ഗ്രാമത്തിൽ താമസിക്കുന്നു.", "ആഴ്ച മുഴുവൻ കാലാവസ്ഥ തണുപ്പായിരുന്നു.", "എനിക്ക് മൂന്ന് പുസ്തകങ്ങൾ വാങ്ങണം.", "കുട്ടികൾ പുറത്ത് കളിക്കുന്നു കാരണം കാലാവസ്ഥ നല്ലതാണ്.", "ഇവിടെ അടുത്ത് നല്ല ഒരു റെസ്റ്റോറന്റ് എവിടെ കിട്ടും?", "അവൾ എന്നോട് പ്രശ്നം മനസ്സിലാകുന്നില്ല എന്ന് പറഞ്ഞു.", "ഈ പഴയ കെട്ടിടം ഇരുനൂറ് വർഷം മുമ്പ് നിർമ്മിച്ചതാണ്.", "കേരളത്തിലെ കായലുകൾ ലോകപ്രശസ്തമാണ്.", "സദ്യയിൽ ഇരുപത്തിയാറിലധികം വിഭവങ്ങൾ ഉണ്ടാകും.", "ഓണം കേരളത്തിന്റെ ഏറ്റവും വലിയ ഉത്സവമാണ്.", "ബസ് നിറഞ്ഞുകഴിഞ്ഞു, ഇരിക്കാൻ സ്ഥലമില്ല.", "മഴക്കാലത്ത് വെള്ളപ്പൊക്കം സാധാരണമാണ്.", "അമ്മ എല്ലാ ഞായറാഴ്ചയും അവിയൽ ഉണ്ടാക്കും.", "വിഷു ദിനത്തിൽ കണികാണുന്നത് ശുഭമാണ്.", "ചായയും പലഹാരവും കഴിച്ച് സായാഹ്നം ചിലവഴിക്കും.", "കറന്റ് പോയി, മെഴുകുതിരി കത്തിക്കണം.", "നെൽപ്പാടങ്ങളിൽ ഞാറ് നടുന്ന സമയമായി.", "തെയ്യം കേരളത്തിന്റെ പ്രത്യേക കലാരൂപമാണ്.", "ചെമ്മീൻ കറിയും ചോറും ഞങ്ങളുടെ പ്രിയ ഭക്ഷണമാണ്.", "മെഡിക്കൽ ഷോപ്പ് പോസ്റ്റ് ഓഫീസിന് എതിർവശം ഇന്ന് അടച്ചിരിക്കുന്നു.", "എന്റെ മുത്തച്ഛൻ ചെറുപ്പത്തിൽ ബേക്കറിയിൽ ജോലി ചെയ്തിരുന്നു.", "ഇത് നല്ല ആശയമാണോ എന്ന് എനിക്ക് ഉറപ്പില്ല.", "അവൻ രാവിലെ ട്രെയിനിൽ കയറി.", "എന്റെ ചേച്ചി അവധിക്ക് പോയി."]
  },
  {
    id: 'kannada', name: 'Kannada', aliases: ['kannada', 'ಕನ್ನಡ'], family: 'Dravidian', region: 'Asia', tier: 4, script: 'Kannada',
    clue: "Round script similar to Telugu, but Kannada is identified by its open hooks and prominent right-side curves in many letters. Headline absent (unlike Hindi).",
    confusedWith: ['Telugu', 'Tamil', 'Malayalam'],
    sentences: ["ಇಂದು ಮಾರುಕಟ್ಟೆ ಎಷ್ಟು ಗಂಟೆಗೆ ಮುಚ್ಚುತ್ತದೆ?", "ನನ್ನ ಅಜ್ಜಿ ಬೆಂಗಳೂರು ಹತ್ತಿರದ ಒಂದು ಸಣ್ಣ ಹಳ್ಳಿಯಲ್ಲಿ ವಾಸಿಸುತ್ತಾರೆ.", "ವಾರವಿಡೀ ಹವಾಮಾನ ತುಂಬಾ ಚಳಿಯಾಗಿತ್ತು.", "ನನಗೆ ಮೂರು ಪುಸ್ತಕಗಳನ್ನು ಕೊಳ್ಳಬೇಕು.", "ಮಕ್ಕಳು ಹೊರಗೆ ಆಟ ಆಡುತ್ತಿದ್ದಾರೆ ಯಾಕೆಂದರೆ ಹವಾಮಾನ ಚೆನ್ನಾಗಿದೆ.", "ಇಲ್ಲಿ ಹತ್ತಿರ ಒಳ್ಳೆಯ ರೆಸ್ಟೋರೆಂಟ್ ಎಲ್ಲಿ ಸಿಗುತ್ತದೆ?", "ಅವಳು ಸಮಸ್ಯೆ ಅರ್ಥವಾಗಲಿಲ್ಲ ಎಂದು ಹೇಳಿದಳು.", "ಈ ಹಳೆಯ ಕಟ್ಟಡವನ್ನು ಇನ್ನೂರು ವರ್ಷಗಳ ಹಿಂದೆ ಕಟ್ಟಲಾಯಿತು.", "ಮೈಸೂರು ಅರಮನೆ ಕರ್ನಾಟಕದ ಹೆಮ್ಮೆಯ ಸ್ಮಾರಕ.", "ಬಿಸಿಬೇಳೆ ಬಾತ್ ಮತ್ತು ದೋಸೆ ನಮ್ಮ ಮೆಚ್ಚಿನ ತಿಂಡಿಗಳು.", "ದಸರಾ ಹಬ್ಬದಲ್ಲಿ ಮೈಸೂರಿನಲ್ಲಿ ಆನೆ ಮೆರವಣಿಗೆ ನಡೆಯುತ್ತದೆ.", "ಬಸ್ ತುಂಬಿಹೋಗಿತ್ತು, ನಿಂತುಕೊಂಡು ಹೋಗಬೇಕಾಯಿತು.", "ಮಳೆಗಾಲದಲ್ಲಿ ಜೋಗ ಜಲಪಾತ ಅದ್ಭುತವಾಗಿ ಕಾಣುತ್ತದೆ.", "ಅಮ್ಮ ಪ್ರತಿ ಭಾನುವಾರ ಸಾಂಬಾರ್ ಮಾಡುತ್ತಾರೆ.", "ಉಗಾದಿ ಹಬ್ಬಕ್ಕೆ ಬೇವು ಬೆಲ್ಲ ತಿನ್ನುತ್ತೇವೆ.", "ಸಂಜೆ ಫಿಲ್ಟರ್ ಕಾಫಿ ಕುಡಿಯುವುದು ನಮ್ಮ ಅಭ್ಯಾಸ.", "ಕರೆಂಟ್ ಮತ್ತೆ ಹೋಯಿತು, ಮೊಮ್ಬತ್ತಿ ಹಚ್ಚಬೇಕು.", "ಹೊಲದಲ್ಲಿ ರಾಗಿ ಬೆಳೆಯುವ ಕಾಲ ಬಂದಿದೆ.", "ಯಕ್ಷಗಾನ ಕರ್ನಾಟಕದ ವಿಶಿಷ್ಟ ಕಲೆ.", "ಮದುವೆಯಲ್ಲಿ ಎಲ್ಲಾ ಬಂಧುಗಳು ಸೇರುತ್ತಾರೆ.", "ಔಷಧಿ ಅಂಗಡಿ ಅಂಚೆ ಕಚೇರಿ ಎದುರಿಗೆ ಇಂದು ಮುಚ್ಚಿದೆ.", "ನನ್ನ ತಾತ ಚಿಕ್ಕವರಿದ್ದಾಗ ಬೇಕರಿಯಲ್ಲಿ ಕೆಲಸ ಮಾಡುತ್ತಿದ್ದರು.", "ಇದು ಒಳ್ಳೆಯ ಯೋಚನೆ ಎಂದು ನನಗೆ ಖಚಿತವಿಲ್ಲ.", "ಅವನು ಬೆಳಿಗ್ಗೆ ರೈಲು ಹತ್ತಿದನು.", "ನನ್ನ ಅಕ್ಕ ರಜೆಗೆ ಹೋದಳು."]
  },
  {
    id: 'gujarati', name: 'Gujarati', aliases: ['gujarati', 'ગુજરાતી'], family: 'Indo-Aryan', region: 'Asia', tier: 4, script: 'Gujarati',
    clue: "Looks like Hindi/Devanagari but WITHOUT the headline bar across the top. Letters hang independently. Same shapes as Devanagari minus the top line.",
    confusedWith: ['Hindi', 'Marathi', 'Bengali'],
    sentences: ["આજે બજાર કેટલા વાગે બંધ થાય છે?", "મારી દાદી અમદાવાદ નજીકના એક નાના ગામમાં રહે છે.", "આખા અઠવાડિયે હવામાન ખૂબ ઠંડુ હતું.", "મારે ત્રણ પુસ્તકો ખરીદવા છે.", "બાળકો બહાર રમી રહ્યા છે કારણ કે હવામાન સારું છે.", "અહીં નજીકમાં સારી રેસ્ટોરન્ટ ક્યાં મળશે?", "તેણીએ મને કહ્યું કે તેને સમસ્યા સમજાતી નથી.", "આ જૂની ઇમારત બસો વર્ષ પહેલા બંધાઈ હતી.", "ગાંધીનગર ગુજરાતની રાજધાની છે.", "ઢોકળા અને ફાફડા ગુજરાતી નાસ્તાની ઓળખ છે.", "નવરાત્રિમાં ગરબા રમવા બધા ભેગા થાય છે.", "બસ ભરાઈ ગઈ હતી, ઊભા રહીને જવું પડ્યું.", "ઉનાળામાં કેરીનો રસ પીવાની મજા જ કંઈ ઓર છે.", "મમ્મી દર રવિવારે ઉંધિયું બનાવે છે.", "દિવાળીમાં ઘર સાફ કરીને રંગોળી પૂરીએ છીએ.", "ચાની કીટલી પર સાંજે ભેગા થઈને વાતો કરીએ છીએ.", "લાઈટ ફરી ગઈ, ઇન્વર્ટર પણ બંધ થઈ ગયું.", "ખેતરમાં મગફળી વાવવાનો સમય આવી ગયો છે.", "રણ ઉત્સવ કચ્છમાં દર વર્ષે ખૂબ મશહૂર છે.", "સુરતનું ઝરી કામ આખી દુનિયામાં જાણીતું છે.", "દવાની દુકાન પોસ્ટ ઓફિસ સામે આજે બંધ છે.", "મારા દાદા જુવાનીમાં બેકરીમાં કામ કરતા હતા.", "મને ખાતરી નથી કે આ સારો વિચાર છે.", "તે સવારે ટ્રેનમાં બેઠો.", "મારી બહેન રજા પર ગઈ છે."]
  },
  {
    id: 'fijian', name: 'Fijian', aliases: ['vosa vakaviti'], family: 'Austronesian', region: 'Oceania', tier: 4, script: 'Latin',
    clue: "B is pronounced 'mb', d is pronounced 'nd', g is 'ng', c is 'th'. Very few consonant clusters. Frequent vowel sequences. Words: na, ni, ko, e, mai.",
    confusedWith: ['Samoan', 'Tongan', 'Maori'],
    sentences: ["Ni sa cava na makete edaidai?", "Noqu bubu e tiko ena koro lailai e voleka ki Suva.", "Na draki sa batabata vakalevu ena macawa taucoko.", "Au gadreva me'u volia e tolu na ivola.", "Na gone era qito i tuba ni sa vinaka na draki.", "Evei e rawa ni'u kunea e dua na vale ni kana vinaka oqo voleka?", "A kaya vei au ni sa sega ni kila na leqa.", "Oqo na vale makawa sa tara tiko e rua na drau na yabaki sa oti.", "Na lovo sa dua na ivakacakacaka ni kana vakavanua.", "Na yaqona e dua na waiwai bibi ena ivakarau vakaViti.", "Ena siga ni sucu, na matavuvale e bose vata me kana.", "Na basi sa sivia na lewe kina, sega na vanua ni dabe.", "Ena vula i Noveba e tiko na cava levu ena baravi.", "Tinai e vakasaqa na ika kei na dalo yadra.", "Na siga ni Viti sa dua na siga bibi vei ira kece na iTaukei.", "Ena Siga ni Sucu se Karisimasi e tiko na marau levu.", "Na vu ni niu e tu voleka ni vale me baleta na waiwai.", "E vuqa na tamata era lako ki wai me ra qoli.", "Na bula vakavanua e vakabibi vei ira na kai Viti.", "Ena gauna ni uca na uciwai e tiko na waluvu.", "Na sitoa ni wainimate e voleka ni posiofisi sa sogo edaidai.", "Noqu tukai a cakacaka ena vale ni madrai ni sa gone.", "Au sega ni vakabauta ni sa vinaka na vakasama oqo.", "A gade ena sitima ena mataka.", "Noqu taci yalewa sa lako ki na malolo."]
  },
  {
    id: 'javanese', name: 'Javanese', aliases: ['basa jawa', 'jawa'], family: 'Austronesian', region: 'Asia', tier: 4, script: 'Latin',
    clue: "Like Indonesian but with speech levels (ngoko/krama). Unique: è and é (open/closed e), frequent dh and th digraphs, words ending in -ake/-aken. No q, x, z in native words.",
    confusedWith: ['Indonesian', 'Sundanese', 'Malay'],
    sentences: ["Pasar tutupé jam pira dina iki?", "Simbahku manggon ing désa cilik cedhak Yogyakarta.", "Hawané adhem banget sak minggu iki.", "Aku arep tuku buku telu.", "Bocah-bocah padha dolanan ing njaba amerga hawané apik.", "Nang endi aku bisa nemokké restoran sing apik nang kéné?", "Dhèwèké kandha yèn ora mudheng masalahe.", "Gedhung lawas iki dibangun rong atus taun kepungkur.", "Borobudur minangka candhi Budha paling gedhé ing donya.", "Gudeg lan tempe bacem iku panganan khas Yogyakarta.", "Ing wulan Syawal, sedulur-sedulur padha silaturahmi.", "Bis wis kebak, ora ana papan kanggo lungguh.", "Ing mangsa rendheng, banjir kerep kedadéan.", "Ibu masak rawon kanggo nedha bengi saben Jumat.", "Sekaten iku festival sing ditunggu-tunggu saben taun.", "Becak isih dadi transportasi ing kutha-kutha Jawa.", "Listrik mati manèh, kudu nganggo lilin.", "Pari ing sawah wis siap dipanèn.", "Wayang kulit iku kabudayan Jawa sing diakoni UNESCO.", "Gamelan muni ing saben acara adat.", "Apoték ing ngarep kantor pos dina iki tutup.", "Simbahku biyèn nyambut gawé ing toko roti nalika isih enom.", "Aku ora yakin yèn iku idé sing apik.", "Dhèwèké numpak sepur ésuk mau.", "Mbakyu-ku lunga piknik."]
  },
  {
    id: 'swati', name: 'Swati', aliases: ['siswati', 'swazi'], family: 'Bantu', region: 'Africa', tier: 4, script: 'Latin',
    clue: "Bantu language with noun class prefixes (si-/ti- for things, umu-/aba- for people). No click consonants (unlike Zulu/Xhosa). Frequent 'eku-' and '-ndze-' combinations.",
    confusedWith: ['Zulu', 'Xhosa', 'Ndebele'],
    sentences: ["Litolo livala nini lamuhla?", "Gogo wami uhlala edolobhaneni lelincane eduze neMbabane.", "Litulu belibandza lonkhe liviki.", "Ngifuna kutshenga tincwadzi letintsatfu.", "Bantfwana badlala ngephandle ngobe litulu lihle.", "Ngingalitfola kuphi lirestorenti lelihle lapha eduze?", "Wangitjela kutsi akayicondzi inkinga.", "Lesakhiwo lesidzala sakhiwa eminyakeni lengemakhulu lamabili leyendlula.", "INcwala ngumkhosi lomkhulu webantfu bemaSwati.", "Emahewu nesidvudvu kutsi kudla kwemaSwati.", "Umhlanga ngumgidvo lowentiwa ngintfombi temakhosikati.", "Libhasi beligcwele kakhulu, asizange sitfole situlo.", "Ngesikhatsi semvula imifula iyagcwala.", "Make upheka inyama yenkukhu nelipalishi ngelilanga leliSontfo.", "Emakhosi anendlela yawo yekwenta tintfo.", "Tinkhomo tibalulekile kakhulu kulesive.", "Ugesi uphindze wahamba, kufanele sisebentise emakhandlela.", "Ensimini batjala umbila netindlubu.", "Kugidza ngumgidvo lomusha emkhosini.", "Umuntfu lomusha uyamukelwa ngelikhekhe.", "Likemisi lelingaphesheya kweposi livaliwe lamuhla.", "Mkhulu wami wasebenta esitolo sesinkhwa asemncane.", "Angikacondzi kutsi loku ngumbono lomuhle.", "Wagibela esitimela ekuseni lamuhla.", "Sisi wami wahamba eholidini."]
  },
  {
    id: 'tatar', name: 'Tatar', aliases: ['tatarcha', 'татарча'], family: 'Turkic', region: 'Europe/Asia', tier: 4, script: 'Cyrillic',
    clue: "Cyrillic Turkic like Kazakh/Kyrgyz but with unique letters: Ә, Ө, Ү, Җ, Ң, Һ. The Җ (dzh with tail) is distinctive. Agglutinative with vowel harmony.",
