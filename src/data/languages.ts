...
export const languages: Language[] = [
  ...
  },
  {
    ...
    sentences: ["U koliko sati se danas zatvara pijaca?", "Moja nana živi u malom selu blizu Sarajeva.", "Vrijeme je bilo prilično hladno cijelu sedmicu.", "Želio bih kupiti tri knjige, molim vas.", "Djeca se igraju vani jer je lijepo vrijeme.", "Gdje u blizini mogu naći dobar restoran?", "Rekla mi je da ne razumije problem.", "Ova stara zgrada izgrađena je prije dvjesta godina.", "Baščaršija je srce starog Sarajeva sa zanatskim radnjama.", "Ćevapi u somunu sa lukom su naša najpoznatija hrana.", "Za Bajram se porodica okuplja i priprema se baklavа.", "Autobus je kasnio dvadeset minuta zbog saobraćaja.", "Bosanska kahva se pije iz fildžana uz lokum.", "Komšiluk je važan dio života u bosanskim mahalama.", "Zimi se u planinama skija, a ljeti se ide na rijeku.", "Iftar u Ramazanu je poseban porodični trenutak.", "Stari most u Mostaru privlači hiljade turista godišnje.", "Pita zeljanica i burek su na svakom sofri ujutro.", "Akšam je posebno lijep uz ezan sa minareta.", "Priroda u Bosni je predivna, šume i rijeke svuda.", "Apoteka naspram pošte je danas zatvorena.", "Moj dedo je radio u pekari na periferiji grada.", "Nisam siguran da je to dobra ideja.", "Ujutru je sjeo u voz.", "Moja sestra je otišla na odmor."]
  },
  {
