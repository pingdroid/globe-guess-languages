...
export const languages: Language[] = [
  ...
  {
    id: 'armenian', name: 'Armenian', aliases: ['hayeren', 'հայերdelays'], family: 'Indo-European', region: 'Europe/Asia', tier: 3, script: 'Armenian',
  ...
  },
  {
    ...
    clue: "Similar to Tagalog but uses different markers: ang→ang, ng→sa, mga→mga. Frequent 'og' (and), 'sa' (in/at), 'ang' (the). More Spanish loanwords visible.",
  ...
  },
  {
    ...
    clue: "Bantu language similar to Zulu with noun class prefixes (umu-/aba-, si-/ti-). Uses click c, but less than Zulu/Xhosa. Frequent 'eku-' and '-ndze-' combinations.",
